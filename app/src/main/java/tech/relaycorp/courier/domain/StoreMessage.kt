    ...
    constructor(
        ...
        private suspend fun storeMessage(
            ...
            val recipientAddress =
                if (recipientType == GatewayType.Internet) {
        ...
        private suspend fun checkForAvailableSpace(dataSize: StorageSize) = getStorageUsage.get().available >= dataSize
